...
public class PaperEventHandler implements Listener {
    ...
    public void EntityAddToWorldEvent(EntityAddToWorldEvent event){
        ...
        if(tnt.getSource() == null){
            ...
            InterceptTntIgnition(sources, latestSource, b, tnt, true);
        }else{
            if(tnt.getSource() instanceof Projectile){
                ...
                InterceptTntIgnition(sources, latestSource, b, tnt, false);
                ...
                InterceptTntIgnition(sources, latestSource, b, tnt, isRedstoneActivated);
            }else{
                sources.add(tnt.getSource().getUniqueId());
                InterceptTntIgnition(sources, tnt.getSource().getUniqueId(), b, tnt, false);
            }
        }
    }

    public void InterceptTntIgnition(HashSet<UUID> sources, UUID latestSource, Block block, TNTPrimed tnt, boolean redstoneActivated){
