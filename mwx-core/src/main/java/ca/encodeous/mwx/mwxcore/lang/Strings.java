package ca.encodeous.mwx.mwxcore.lang;
...
public class Strings {
    ...
    public static String PLAYERS_ONLINE = Chat.FCL("&2Currently there are %s player(s) online.\n");
    ...
    public static String RANKED_TEAM_READY = Chat.FCL("&fThe %s &fis now ready.");
